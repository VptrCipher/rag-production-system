...
def run_live_test():
    ...
    for i, q in enumerate(queries, 1):
        ...
        response = client.post("/api/v1/query", json={"question": q["question"], "session_id": "live_demo_test"})

        result_entry = {"test_name": q["name"], "question": q["question"], "status_code": response.status_code}
